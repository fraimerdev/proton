...
- Files: `assets/Inter-latin-400.ttf`, `assets/Inter-latin-700.ttf`
- Upstream: https://github.com/rsms/inter
- Obtained from: the `@fontsource/inter` npm package (`inter-latin-400-normal.woff2`
  and `inter-latin-700-normal.woff2`), decompressed WOFF2 → TTF. Nothing else was
  changed: no reshaping, no renaming, no subsetting beyond the latin subset the
  upstream package already ships.
- Licence: SIL Open Font License, Version 1.1

OFL 1.1 permits bundling and redistribution inside a commercial product, including a
