...
import {
  renderGiveawayBonusGranted,
  renderGiveawayCancelled,
  renderGiveawayCreated,
  renderGiveawayEdited,
  renderGiveawayEnded,
  renderGiveawayPaused,
  renderGiveawayRerolled,
  renderGiveawayResumed,
  renderGiveawayStarted,
} from './render/giveaways.ts';
import {
  renderMemberJoined,
  renderMemberLeft,
...
const SPECS: LogEventSpec[] = [
  ...
  {
    key: 'proton.giveaway_created',
    category: 'proton',
    label: 'Giveaway created',
    colour: ServerLogColors.Add,
  ...
  {
    key: 'proton.giveaway_edited',
    category: 'proton',
    label: 'Giveaway edited',
    colour: ServerLogColors.Modify,
  ...
  {
    key: 'proton.giveaway_paused',
    category: 'proton',
    label: 'Giveaway paused',
    colour: ServerLogColors.Modify,
  ...
  {
    key: 'proton.giveaway_resumed',
    category: 'proton',
    label: 'Giveaway resumed',
    colour: ServerLogColors.Add,
  ...
  {
    key: 'proton.giveaway_ended',
    category: 'proton',
    label: 'Giveaway drawn',
    colour: ServerLogColors.Add,
  ...
  {
    key: 'proton.giveaway_rerolled',
    category: 'proton',
    label: 'Giveaway rerolled',
    colour: ServerLogColors.Modify,
  ...
  {
    key: 'proton.giveaway_bonus',
    category: 'proton',
    label: 'Giveaway entries granted',
    colour: ServerLogColors.Add,
