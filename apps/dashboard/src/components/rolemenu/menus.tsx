        ...
        <fieldset className="ladder-rung rolemenu-menu" key={menu.id || `menu-${menuIndex}`}>
          ...
          <label className="filter">
            ...
            <select
              ...
              aria-invalid={menu.channelId === ''}
              onChange={(e) => updateMenu(menuIndex, { channelId: e.target.value })}
            >
            ...
            >
              <label className="filter">
                ...
                <input
                  type="text"
                  value={binding.key}
                  onChange={(e) => updateBinding(menuIndex, bindingIndex, { key: e.target.value })}
                />
              </label>
              ...
              <label className="filter">
                ...
                <select
                  ...
                  aria-invalid={binding.roleId === ''}
                  onChange={(e) =>
                    updateBinding(menuIndex, bindingIndex, { roleId: e.target.value })
                  }
                >
