              ...
              {panel.typeIds.length === 0 ? (
                ...
                <Rows>
                  {panel.typeIds.map((typeId, at) => {
                    ...
                    // Counted over the ids that still resolve: an entry left behind by a deleted
                    // type is dropped before the fifteen are counted, so it does not use a slot.
                        ...
                        <span className="tickets-typeid-main">
                          ...
                          {type === undefined ? (
                            <span className="text-danger">
                              No ticket type has the ID <span className="mono">{typeId}</span>. It
                              was deleted, so this entry opens nothing.
                            </span>
                          ) : (
                            <>
