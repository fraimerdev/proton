  ...
  return (
    <>
      ...
      <ModuleSettings form={form}>
        <SettingsGrid>
          <SectionCard
            id="antiraid:detection"
            title="Detection"
            hint="A join scores against these; the score decides whether it is a raid."
          >
            <FieldRow>
              <Num
                path="joinThreshold"
          ...
          <SectionCard
            id="antiraid:response"
            title="Response"
            hint="What happens to a join the score flags, and where Proton reports it."
          >
            <Choice
              path="response"
              label="Response"
              options={RAID_RESPONSES}
              defaultValue="verify"
            />
            <FieldRow>
              <RoleField
