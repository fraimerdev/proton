  ...
  return (
    <>
      ...
      <ModuleSettings form={form}>
        <SettingsGrid>
          {/* Half. Spanning the grid put "Per member" and "Window" six hundred pixels from the
              name of the thing being counted, and left Response alone on a row of its own; at half
              the pair wraps under the name it belongs to and the whole breaker is one screen. */}
          <SectionCard
            id="antinuke:thresholds"
            title="Thresholds"
            hint="How much one member may delete or remove before the breaker trips."
          >
          ...
          <SectionCard id="antinuke:response" title="Response">
            <Choice
              path="afterStrip"
